...
plot(impoints2D(:, 1), impoints2D(:, 2), 'b.', 'MarkerSize', 10)

hold off;

 sumDif = sum((impoints2D-estim).^2);
disp(sumDif);
%% Part 2
...
% Define images to process, will need to be redone for every new device
imageFileNames = {'Images\IMG_7300.jpg',...
    'Images\IMG_7301.jpg',...
    'Images\IMG_7302.jpg',...
    'Images\IMG_7303.jpg',...
    'Images\IMG_7304.jpg',...
